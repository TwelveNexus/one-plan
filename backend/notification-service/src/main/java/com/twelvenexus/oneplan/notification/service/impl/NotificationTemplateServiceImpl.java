...
public class NotificationTemplateServiceImpl implements NotificationTemplateService {
    ...
    @Override
    public NotificationTemplate createTemplate(String name, NotificationType type,
    ...
    @Override
    public NotificationTemplate updateTemplate(UUID templateId, String subject,
    ...
    public NotificationTemplate getTemplate(NotificationType type, NotificationChannel channel,
        ...
        return templateRepository.findActiveTemplate(type, channel, language)
            .orElse(templateRepository.findActiveTemplate(type, channel, "en")
                .orElse(null));
    }
