...
public interface NotificationService {
    ...
    Notification createNotification(UUID userId, UUID tenantId, NotificationType type, 
                                   String title, String content, Map<String, String> metadata);
    
    Notification sendNotification(UUID userId, UUID tenantId, NotificationType type,
                                 NotificationChannel channel, String title, String content,
                                 Map<String, String> metadata);
    
    void sendNotificationAsync(UUID userId, UUID tenantId, NotificationType type,
                              NotificationChannel channel, String title, String content,
                              Map<String, String> metadata);
