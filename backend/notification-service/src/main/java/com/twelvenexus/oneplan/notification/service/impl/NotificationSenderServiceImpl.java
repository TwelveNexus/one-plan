...
public class NotificationSenderServiceImpl implements NotificationSenderService {
    ...
    public void sendEmail(Notification notification) {
        try {
            ...
            NotificationTemplate template = templateService.getTemplate(
                notification.getType(), notification.getChannel(), "en");
            ...
            notification.setStatus(com.twelvenexus.oneplan.notification.enums.NotificationStatus.DELIVERED);
    ...
    public void sendPush(Notification notification) {
        try {
            ...
            pushPayload.put("notification", Map.of(
    ...
    public void sendSms(Notification notification) {
        try {
            ...
            headers.setBasicAuth(notification.getMetadata().get("twilioAccount"), 
