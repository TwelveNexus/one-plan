...
public class InvoiceServiceImpl implements InvoiceService {
    ...
    public Invoice generateInvoice(UUID subscriptionId, LocalDate invoiceDate) {
        ...
        item.setAmount(subscription.getAmount().multiply(BigDecimal.valueOf(subscription.getQuantity())));
        ...
        log.info("Generated invoice {} for subscription {}", invoice.getInvoiceNumber(), subscriptionId);
    ...
    public byte[] generateInvoicePDF(UUID invoiceId) {
        ...
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            document.add(new Paragraph(companyAddress)
                .setFontSize(12)
                .setTextAlignment(TextAlignment.CENTER));
            document.add(new Paragraph("GSTIN: " + gstNumber)
                .setFontSize(10)
                .setTextAlignment(TextAlignment.CENTER));
            ...
            if (invoice.getBillingAddress() != null) {
                ...
                document.add(new Paragraph(addr.getCity() + ", " + addr.getState() + " " + addr.getPostalCode()));
