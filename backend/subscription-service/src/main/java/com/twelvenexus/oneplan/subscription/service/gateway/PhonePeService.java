...
public class PhonePeService implements PaymentGatewayService {
    ...
    public PhonePeService(@Value("${payment.phonepe.merchant-id}") String merchantId,
    ...
    @Override
    public Payment createOrder(String orderId, BigDecimal amount, String currency,
    ...
    public Payment refundPayment(String paymentId, BigDecimal amount, String reason) {
        try {
            ...
            String base64Body = Base64.getEncoder().encodeToString(request.toString().getBytes());
            String checksum = calculateChecksum(base64Body + "/pg/v1/refund" + saltKey) + "###" + saltIndex;
    ...
    @Override
    public Map<String, Object> createPaymentLink(BigDecimal amount, String currency,
