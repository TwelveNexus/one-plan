...
public class PaymentServiceImpl implements PaymentService {
    ...
    @Override
    public Payment initiatePayment(UUID tenantId, UUID subscriptionId, BigDecimal amount,
    ...
    @Override
    public Payment completePayment(String gatewayOrderId, String gatewayPaymentId,
                                  String signature, PaymentGateway gateway) {
        Payment payment = paymentRepository.findByGatewayOrderId(gatewayOrderId)
            .orElseThrow(() -> new IllegalArgumentException("Payment not found"));

        PaymentGatewayService gatewayService = getGatewayService(gateway);
        Payment verifiedPayment = gatewayService.verifyPayment(gatewayOrderId, gatewayPaymentId, signature);
    ...
    public Payment refundPayment(UUID paymentId, BigDecimal amount, String reason) {
        ...
        Payment refundedPayment = gatewayService.refundPayment(
    ...
    @Override
    public Map<String, Object> createPaymentLink(UUID tenantId, UUID subscriptionId,
        ...
        PaymentGatewayService gatewayService = getGatewayService(gateway);
        Map<String, Object> linkDetails = gatewayService.createPaymentLink(
            amount, "INR", "Subscription Payment", metadata
        );
    ...
    @Override
    public PaymentMethod savePaymentMethod(UUID tenantId, PaymentGateway gateway,
