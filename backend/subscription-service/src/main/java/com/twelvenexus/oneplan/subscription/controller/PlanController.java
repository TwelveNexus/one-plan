...
public class PlanController {
  ...
  public ResponseEntity<PlanDto> updatePlan(
      @PathVariable UUID planId, @Valid @RequestBody UpdatePlanDto dto) {
    Plan plan =
  ...
  public ResponseEntity<List<PlanDto>> getAllPlans() {
    ...
    return ResponseEntity.ok(plans.stream().map(this::toDto).collect(Collectors.toList()));
  }
  ...
  public ResponseEntity<Void> markAsPopular(
      @PathVariable UUID planId, @RequestParam boolean popular) {
