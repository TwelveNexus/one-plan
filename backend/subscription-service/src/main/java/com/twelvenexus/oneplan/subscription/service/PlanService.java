...
public interface PlanService {
    ...
    Plan createPlan(String code, String name, String description, PlanType type,
                   BigDecimal basePrice, Map<BillingCycle, BigDecimal> billingCyclePrices,
                   Map<String, String> features, Map<String, Integer> limits);

    Plan updatePlan(UUID planId, String name, String description,
                   Map<BillingCycle, BigDecimal> prices, Map<String, String> features,
