...
public interface DashboardService {
    ...
    Dashboard createDashboard(UUID tenantId, String name, String description,
                             UUID ownerId, boolean isPublic);

    Dashboard updateDashboard(UUID dashboardId, String name, String description,
                             boolean isPublic);
    ...
    DashboardWidget addWidget(UUID dashboardId, String title, String type,
                             Map<String, String> configuration, Integer position,
                             Integer width, Integer height);

    DashboardWidget updateWidget(UUID widgetId, String title,
