...
public interface AnalyticsEventService {
    ...
    void trackEvent(UUID tenantId, UUID entityId, String entityType,
    ...
    List<AnalyticsEvent> getEvents(UUID tenantId, UUID entityId,
                                  LocalDateTime start, LocalDateTime end);

    List<AnalyticsEvent> getUserEvents(UUID tenantId, UUID userId,
                                      LocalDateTime since);

    Map<String, Long> getEventCounts(UUID tenantId, String entityType,
                                    LocalDateTime since);
