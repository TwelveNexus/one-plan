...
public class ReportController {
  ...
  public ResponseEntity<ReportDto> createReport(
    ...
    Report report =
        reportService.createReport(
            tenantId, dto.getName(), dto.getType(), dto.getParameters(), userId, dto.getSchedule());
  ...
  public ResponseEntity<ReportDto> updateReport(
      @PathVariable UUID reportId, @Valid @RequestBody UpdateReportDto dto) {
    Report report =
        reportService.updateReport(reportId, dto.getName(), dto.getParameters(), dto.getSchedule());
  ...
  public ResponseEntity<byte[]> exportReport(
      @PathVariable UUID reportId, @RequestParam(defaultValue = "csv") String format) {
